...
class lmo_dataset(Dataset):
    def __init__(self, data_path, data_name, data_type,
        ...
        self.ref_data = {}
        self.view_data_list = {}
        with open(os.path.join(data_path,  'models_eval', 'models_info.json'), 'r') as f:
    ...
    def get_gt_mesh(self, ob_id):
        ...
        mesh_file = os.path.join(self.data_path, 'models_eval', 'obj_'+ob_id_+'.ply')
    ...
    @staticmethod
    def zoom_in_v2(im, c, s, res=480, interpolate=cv2.INTER_NEAREST):
        """
        copy from
        https://github.com/LZGMatrix/CDPN_ICCV2019_ZhigangLi/blob/master/lib/utils/img.py
